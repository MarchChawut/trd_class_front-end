...
export default function FirstPage() {
  ...
  const [subjects, setSubjects] = React.useState({ID:0,RoomName:"",ClassSubject:""});
  ...
  async function submitDataForRegister() {
    ...
    const firstlastname = (document.querySelector("#firstlastname") as HTMLInputElement)
      .value;
    
    const email = (document.querySelector("#email") as HTMLInputElement).value;
    
    const division = (document.querySelector("#division") as HTMLInputElement)
      .value;
    const department = (
      document.querySelector("#department") as HTMLInputElement
    ).value;
  ...
  return (
    <div className="md:flex md:flex-col2 sm:flex-col1 justify-center items-center w-screen h-screen">
      ...
      <section id="leftComponent" className="grid justify-center items-center md:w-2/4 md:h-2/4">
      ...
      <div className="flex flex-col items-center justify-center ">
        ...
        <div className="w-full rounded-lg  md:mt-0 sm:max-w-md xl:p-0">
          <div className="p-6 space-y-1 md:space-y-2 sm:p-8">
            ...
            >
              ...
              <div>
                ...
                <Select sx={{  minWidth: 1, backgroundColor:"#374151", color:"white", borderRadius: '5px' }}
                  labelId="member"
                  id="member"
                  value={member}
                  label="member"
                ...
                >
                  {publicRuntimeConfig.MEMBERS.map((detail, i) => {
                        return (
                            <MenuItem key={i} value={detail}>{detail}</MenuItem>
                        )
                    })}
              </Select>
              ...
              <button
                type="submit"
                className="w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-2xl px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
              >
                ลงทะเบียน
              </button>
            </form>
